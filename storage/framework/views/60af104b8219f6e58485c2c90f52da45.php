    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('requests.store')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="form-selectgroup-boxes row mb-3">
                        <div class="col-lg-6">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="type" value="<?php echo e(App\Enums\RequestType::ADD()->value); ?>"
                        ...
                        <div class="col-lg-6">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="type"
                                    value="<?php echo e(App\Enums\RequestType::EXCLUDE()->value); ?>" class="form-selectgroup-input"
                                    required>
                                <span class="form-selectgroup-label d-flex align-items-center p-3">
                                    <span class="me-3">
                                        <span class="form-selectgroup-check"></span>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="currency_id" required>
                                    <?php $__currentLoopData = App\Models\Currency::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/ali/Desktop/projects/tax/resources/views/layouts/modal/request-modal.blade.php ENDPATH**/ ?>